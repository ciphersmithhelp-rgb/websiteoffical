  ...
  head: () => ({
    meta: [
      ...
      { title: "CipherSmith Games — We Forge Legends" },
      {
        name: "description",
        content:
          "CipherSmith Games is a digital forge crafting cinematic AAA worlds inspired by mythology, imagination and technology.",
      },
      { property: "og:title", content: "CipherSmith Games — We Forge Legends" },
      { property: "og:description", content: "A digital forge where legends are crafted." },
