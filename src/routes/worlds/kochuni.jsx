...
export const Route = createFileRoute("/worlds/kochuni")({
  component: KochuniPage,
});

function KochuniPage() {
  return (
        ...
        <div className="flex-1 px-6 pb-24 pt-12 lg:px-20">
          <div className="mx-auto max-w-3xl">
            ...
            <p className="text-lg leading-relaxed text-studios-muted">
              A dark action RPG inspired by Kerala folklore, hidden warriors, and forgotten legends. Set in a rain-soaked world of ancient wisdom and inner battles, Kochuni follows the legend of a warrior whose destiny was written in shadow — and whose choices will determine the fate of Malabar.
            </p>
